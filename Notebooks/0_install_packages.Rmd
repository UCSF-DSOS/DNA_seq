...
* You should already have these packages installed (per setup instructions via email).   
...
bpkgs <- c("VariantAnnotation","cgdv17","org.Hs.eg.db","TxDb.Hsapiens.UCSC.hg19.knownGene",
...
## list CRAN packages
rpkgs <- c("R.utils","knitr") ## knitr only needed if using R notebooks
